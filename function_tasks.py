...
def ensure_local_paths(path: str) -> str:
    ...
    if ((not RUNNING_IN_CODESPACES) and RUNNING_IN_DOCKER): 
        ...
        logging.info(f"Inside ensure_local_paths generate_schema with path: {path}")
        return path.lstrip("/")    

def convert_function_to_openai_schemas(func: Callable) -> dict:
    """
...
def format_file_with_prettier(file_path: str, prettier_version: str):
    ...
    """
    input_file_path = ensure_local_paths(file_path)
...
def query_database(db_file: str, output_file: str, query: str, query_params: Tuple):
    ...
    Returns:
        None
    """
    db_file_path = ensure_local_paths(db_file)
    output_file_path = ensure_local_paths(output_file)
...
def extract_specific_text_using_llm(input_file: str, output_file: str, task: str):
    ...
    Returns:
        None
    """
    input_file_path = ensure_local_paths(input_file)
...
def extract_text_from_image(image_path: str, output_file: str, task: str):
    ...
    image_path___ = ensure_local_paths(image_path)
